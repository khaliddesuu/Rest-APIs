...
document.getElementById("Ucapan").innerHTML = ucapanWaktu;
...
var x = setInterval(function () {
	...
	if (distance < 0) {
		clearInterval(x);
		document.getElementById("Birthday").innerHTML =
			"Selamat Hari Ulang Tahun Owner! 🎉";
	}
}, 1000);
...
const Image = ['https://telegra.ph/file/705978ec4807ddb3a683c.png'];
const Acak = Image[Math.floor(Math.random() * Image.length)];
